...
3. Some desktop environment packages may not be able to setup correctly. If you encounter errors during the package installation, try another desktop selection. I tested `ubuntu-desktop` `ubuntu-desktop-minimal` and `kubuntu-desktop` are working perfectly.
